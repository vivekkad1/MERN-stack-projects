...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-16 pb-16">
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight">
              India's Premium <br className="hidden md:block" />
          ...
          <div className="flex-1 w-full flex justify-center md:justify-end">
            <div className="relative w-full max-w-[500px] aspect-square rounded-2xl overflow-hidden shadow-2xl bg-white/10 backdrop-blur-sm border border-white/20">
      ...
      <section className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {['Mobiles', 'Fashion', 'Home Appliances', 'Beauty', 'Groceries', 'Electronics'].map((category, i) => (
            <div key={i} className="group cursor-pointer flex flex-col items-center gap-3 p-4 rounded-xl border bg-card hover:border-primary transition-all hover:shadow-md">
      ...
      {/* Promotional Banner */}
      <section className="container mx-auto px-4 md:px-6">
        <div className="relative rounded-3xl overflow-hidden bg-primary text-primary-foreground p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 mix-blend-overlay" />
          <div className="relative z-10 space-y-4 max-w-lg">
            <h2 className="text-3xl md:text-4xl font-bold">Extra ₹500 Off Your First Order</h2>
          ...
          <div className="relative z-10 w-full md:w-auto">
            <form className="flex gap-2 w-full max-w-sm">
              ...
              />
              <Button variant="secondary" type="submit" onClick={(e) => { e.preventDefault(); alert('Subscribed!') }}>Subscribe</Button>
            </form>
          </div>
        </div>
      </section>
