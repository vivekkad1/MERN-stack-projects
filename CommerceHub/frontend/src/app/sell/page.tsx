...
export default function SellPage() {
  return (
    <div className="flex flex-col gap-16 pb-16 min-h-screen">
      {/* Hero Section */}
      <section className="relative w-full h-[500px] flex items-center justify-center overflow-hidden bg-primary/5">
      ...
      <section className="container px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tight">Why Sell on CommerceHub?</h2>
        </div>
